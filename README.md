# @dramaorg/amet-tenetur [![](http://img.shields.io/npm/dm/@dramaorg/amet-tenetur.svg?style=flat)](https://www.npmjs.org/package/@dramaorg/amet-tenetur) [![Node.js CI](https://github.com/dramaorg/amet-tenetur/actions/workflows/node.js.yml/badge.svg)](https://github.com/dramaorg/amet-tenetur/actions/workflows/node.js.yml)

> Simple to use type-safe local JSON database 🦉
> 
> If you know JavaScript, you know how to use @dramaorg/amet-tenetur.
...
```js
const post = { id: 1, title: '@dramaorg/amet-tenetur is awesome', views: 100 }
...
{
  "posts": [
    { "id": 1, "title": "@dramaorg/amet-tenetur is awesome", "views": 100 }
  ]
}
```
...
posts.filter((post) => post.title.includes('@dramaorg/amet-tenetur')) // Filter by title
...
```sh
npm install @dramaorg/amet-tenetur
```
...
```js
import { JSONFilePreset } from '@dramaorg/amet-tenetur/node'
...
You can extend @dramaorg/amet-tenetur with Lodash (or other libraries). To be able to extend it, we're not using `JSONPreset` here. Instead, we're using lower components.

```ts
import { Low } from '@dramaorg/amet-tenetur'
import { JSONFile } from '@dramaorg/amet-tenetur/node'
...
```js
import { LowSync } from '@dramaorg/amet-tenetur'
import { JSONFileSync } from '@dramaorg/amet-tenetur/node'
...
Holds your db content. If you're using the adapters coming with @dramaorg/amet-tenetur, it can be any type supported by [`JSON.stringify`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON/stringify).
...
```js
import { JSONFile, JSONFileSync } from '@dramaorg/amet-tenetur/node'
...
```js
import { Memory, MemorySync } from '@dramaorg/amet-tenetur'
...
```js
import { LocalStorage, SessionStorage } from '@dramaorg/amet-tenetur/browser'
...
```js
import { DataFile } from '@dramaorg/amet-tenetur/node'
...
If you've published an adapter for @dramaorg/amet-tenetur, feel free to create a PR to add it here.
...
```js
import { Adapter, Low } from '@dramaorg/amet-tenetur'
import { TextFile } from '@dramaorg/amet-tenetur/node'
